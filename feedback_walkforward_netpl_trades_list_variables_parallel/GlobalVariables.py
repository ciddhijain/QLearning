...
databaseName = 'QLRM_AXIS'                            # This is database name to which connection is made
...
performanceMonthlyOutfileNameBase = 'axis netpl monthly 15 15 30'
performanceOutfileNameBase = 'axis netpl 15 15 30'
